...
export class enduid extends plugin {
  ...
  async help() {
    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "角色抽卡记录",
            cmd: `${p}角色抽卡记录 / ${p}角色抽卡记录<UID> / ${p}角色抽卡记录 @用户`,
            desc: "只查看角色池记录",
          },
          {
            name: "武器抽卡记录",
            cmd: `${p}武器抽卡记录 / ${p}武器抽卡记录<UID> / ${p}武器抽卡记录 @用户`,
            desc: "只查看武器池记录",
          },
          {
            name: "更新抽卡记录",
    ...
    const msg = [
      ...
      `- ${p}角色抽卡记录 / ${p}角色抽卡记录<UID> / ${p}角色抽卡记录 @用户  （只看角色池）`,
      `- ${p}武器抽卡记录 / ${p}武器抽卡记录<UID> / ${p}武器抽卡记录 @用户  （只看武器池）`,
